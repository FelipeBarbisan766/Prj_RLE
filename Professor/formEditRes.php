...
<form class="max-w-sm mx-auto" method="POST">
        <div class="mb-5 mt-2">
            ...
            <?php
                ...
                while ($cur = mysqli_fetch_array($slq)) {
                    if ($cur['cur_isActive'] == true) { ?>
                        <option value="<?php echo $cur['cur_cod'];?>"<?php if($res['cur_cod'] == $cur['cur_cod']){echo 'selected';}  ?>><?php echo $cur['cur_nome']; ?></option>
                    <?php }
                }
                ; ?>            
            </select>
            ...
            <div class="mb-5">
            <label for="lab" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Laboratório</label>
            ...
            while ($labs = mysqli_fetch_array($slq)) {
                if ($labs['lab_isActive'] == true) { ?>
                    <option value="<?php echo $labs['lab_cod'];?>" <?php if ($labs['lab_cod'] == $res['lab_cod']) { echo 'selected'; } ?>><?php echo $labs['lab_nome']; ?></option>
                    <?php }
            }
            ; ?>
        </select>
