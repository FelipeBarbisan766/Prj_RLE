...
<div class="container mx-auto px-4">
    ...
    <h1 class="mb-4 text-xs text-center mt-10 font-extrabold tracking-tight leading-none text-gray-900 md:text-3xl lg:text-4xl dark:text-white">Adicionar Professor</h1>
