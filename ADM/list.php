        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <td class="px-6 py-4">
                        <button type="button" data-modal-target="modal-first" data-modal-toggle="modal-first" onclick="OpenModal(<?php echo $prof['prof_cod']; ?>)"
...
<script>
    function OpenModal(cod){
        ...
        $.ajax({
            url: 'edit.php',  // PHP script to handle the request
            type: 'POST',
            data: {
                cod: cod,
            }, 
