...
<div class="container mx-auto px-3">
    ...
    if (isset($_GET['token'])) {
        ...
        if ($quantidade == 1) {
            $slq = mysqli_fetch_array($sql_query);
            $cod = $sql['prof_cod'];
            ?>
            ...
            <form class="mt-3 max-w-sm mx-auto" action="" method="post">
                ...
                <a type="button" href="forgot_password.php" class="mb-2 text-white bg-danger-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">Cancelar</a>
            ...
            echo 'Erro de Token Tente Novamente';
        }
