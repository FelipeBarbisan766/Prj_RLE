...
<div class="container mx-auto px-4">
    ...
    if(isset($_SESSION['nome'])){
        if($_SESSION['cargo'] =='adm'){
            ?>
        <a href="form2.php" class="focus:outline-none dark:text-gray-900 dark:bg-stone-400 dark:border dark:border-stone-400 dark:focus:outline-none dark:hover:bg-teal-100 dark:focus:ring-4 dark:focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 bg-teal-800 text-white border-stone-500 hover:bg-stone-500 hover:border-stone-500 focus:ring-gray-700">Adicionar aula ao Cronograma</a>
